...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-success" id="nav-home-tab" data-toggle="tab" role="tab" aria-controls="nav-home" aria-selected="true">Admin Login</a>
           ...
           <div class="card card-body bg-gradient-success">
                ...
                <form  method="post" action="">     
                    ...
                    <label for="name" class="col-md-3 col-form-label"
                      ><h6 class="text-black font-weight-bold">Admin ID</h6>
                    </label>
                    <div class="col-md-9">
                      <input
                        type="text"
                      ...
                      />
				  				  			  		 ...
				  				  			  		 <div class="form-group row">
                                 <label for="name" class="col-md-3 col-form-label"
                      ><h6 class="text-black font-weight-bold">Password</h6>
                    </label>
			   <div class="col-9">
                ...
                <span class="input-group-text" onclick="password_show_hide();">
                  ...
                  <i class="fas fa-eye-slash d-none" id="hide_eye"></i>
                    ...
                    <div class="offset-md-3 col-md-2">
                      <button
                        type="submit"
                        class="btn btn-fregister text-dark"
