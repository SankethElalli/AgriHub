...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-warning" id="nav-home-tab" data-toggle="tab" role="tab" aria-controls="nav-home" aria-selected="true">Farmer Sign Up</a>
            ...
            <div class="input-group mb-3">
              ...
              <div class="input-group-append">
			   ...
			   <div class="form-group row">
                ...
                <div class="col-md-9">
            <button name="farmerregister" class=" btn-block btn btn-fregister"><span class="glyphicon glyphicon-edit"></span> Submit</button>		
                </div>		
              </div>
            </form>
...
<footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    ...
                    <address>
                    <br>
                    <a role="button" class="btn btn-primary" href="tel:+918088972078"><i class="fa fa-phone"></i> Call</a>
                    
                    <a role="button" class="btn btn-success" href="mailto:elallisanketh7@gmail.com@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>

                    <a role="button" class="btn btn-secondary" href="https://github.com/SankethElalli/AgriHub"><i class="fab fa-github"></i> GitHub</a>
                  </address>
                </div>
              </div>
              <hr>
