...
<head>
  ...
  <link rel="stylesheet" href="assets/css/custom.css" type="text/css"> <!-- Ensure this is included last -->
</head>
        ...
        <form action="contact-script.php" method="post">
          <div class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
            <div class="flex flex-col justify-between">
              <div class="mt-2">
                <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Help? Contact Us!</h2>
              </div>
              <div class="mt-2">
